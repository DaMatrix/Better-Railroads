...
public class ItemSpeedCart extends ItemMinecart {
	...
	public ItemSpeedCart(){
		...
		setUnlocalizedName(MiscRails.MODID + "." + "speed_cart");
		setRegistryName(new ResourceLocation(MiscRails.MODID, "speed_cart"));
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            if (!worldIn.isRemote)
            {
                ...
                SpeedCart entityminecart = new SpeedCart(worldIn, (double)pos.getX() + 0.5D, (double)pos.getY() + 0.0625D + d0, (double)pos.getZ() + 0.5);
