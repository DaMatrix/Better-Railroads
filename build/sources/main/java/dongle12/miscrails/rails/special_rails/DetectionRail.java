...
public class DetectionRail extends BlockRailDetector {
	...
	public DetectionRail(){
        ...
        setUnlocalizedName(MiscRails.MODID + "." + "detection_rail");
        setRegistryName(new ResourceLocation(MiscRails.MODID, "detection_rail"));
        itemBlock = new ItemBlock(this);
        itemBlock.setRegistryName(new ResourceLocation(MiscRails.MODID, "detection_rail"));
        itemBlock.setUnlocalizedName(MiscRails.MODID + "." + "detection_rail");
