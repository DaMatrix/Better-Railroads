...
import dongle12.better_railroads.carts.MinecartChest;
...
public class ItemChestCart extends ItemMinecart {
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            if (!worldIn.isRemote)
            {
                ...
                MinecartChest entityminecart = new MinecartChest(worldIn, (double)pos.getX() + 0.5D, (double)pos.getY() + 0.0625D + d0, (double)pos.getZ() + 0.5);
