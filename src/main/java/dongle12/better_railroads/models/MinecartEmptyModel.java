...
package dongle12.better_railroads.models;
...
public class MinecartEmptyModel extends ModelBase {
    ...
    public MinecartEmptyModel() {
        this.textureWidth = 64;
        this.textureHeight = 64;

        this.e0 = new ModelRenderer(this, 0, 0);
        this.e0.addBox(1F, 1F, 15F, 14, 8, 1, 1.0F);
        this.e1 = new ModelRenderer(this, 0, 0);
        this.e1.addBox(1F, 1F, 0F, 14, 8, 1, 1.0F);
        this.e2 = new ModelRenderer(this, 0, 0);
        this.e2.addBox(0F, 0F, 1F, 1, 2, 2, 1.0F);
        this.e3 = new ModelRenderer(this, 0, 0);
        this.e3.addBox(0F, 0F, 13F, 1, 2, 2, 1.0F);
        this.e4 = new ModelRenderer(this, 0, 0);
        this.e4.addBox(15F, 0F, 13F, 1, 2, 2, 1.0F);
        this.e5 = new ModelRenderer(this, 0, 0);
        this.e5.addBox(15F, 0F, 1F, 1, 2, 2, 1.0F);
