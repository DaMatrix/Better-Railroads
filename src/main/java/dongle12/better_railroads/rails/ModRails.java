...
public class ModRails {
	...
	@GameRegistry.ObjectHolder("better_railroads:speed_rail")
	public static SpeedRail speed_rail;
	
	@GameRegistry.ObjectHolder("better_railroads:powered_speed_rail")
	public static PoweredSpeedRail powered_speed_rail;
	
	@GameRegistry.ObjectHolder("better_railroads:brake_rail")
	public static BrakeRail brake_rail;
	
	@GameRegistry.ObjectHolder("better_railroads:deceleration_rail")
	public static DecelerationRail deceleration_rail;
	
	@GameRegistry.ObjectHolder("better_railroads:wooden_rail")
	public static WoodenRail wooden_rail;
	
	@GameRegistry.ObjectHolder("better_railroads:launching_rail")
	public static LaunchingRail launching_rail;
	
	@GameRegistry.ObjectHolder("better_railroads:intersection_rail")
	public static IntersectionRail intersection_rail;
	
	@GameRegistry.ObjectHolder("better_railroads:detection_rail")
	public static DetectionRail detection_rail;
	
	@GameRegistry.ObjectHolder("better_railroads:jump_rail")
