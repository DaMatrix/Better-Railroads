...
import dongle12.better_railroads.models.MinecartEmptyModel;
...
public class RenderMinecartEmpty<T extends MinecartEmpty> extends Render<T> {
	


	public RenderMinecartEmpty(RenderManager renderManager) {
		super(renderManager);
        this.shadowSize = 0.5F;
	}

	private static final ResourceLocation MINECART_TEXTURES = new ResourceLocation(BetterRailroads.MODID + ":textures/speed_cart.png");
    /** instance of ModelMinecart for rendering */
    protected ModelBase modelMinecart = new MinecartEmptyModel();
