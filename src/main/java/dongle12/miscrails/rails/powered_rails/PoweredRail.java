...
public class PoweredRail extends BlockRailPowered {
	...
	public PoweredRail(String name){
		super();
        setUnlocalizedName(MiscRails.MODID + "." + name);
        setRegistryName(new ResourceLocation(MiscRails.MODID, name));
        
        itemBlock = new ItemBlock(this);
        itemBlock.setRegistryName(new ResourceLocation(MiscRails.MODID, name));
        itemBlock.setUnlocalizedName(MiscRails.MODID + "." + name);
